...
const ExperimentPage = () => (
  <div className="page--light row justify-content-center">
    <div className="col-10 col-md-5" style={{height: '3rem'}}>
      <Title>實驗結果分析</Title>
    </div>
    <div className="w-100"></div>

    <div className="col-10 col-md-5">
      <div className="height-wrapper1">
      ...
      <GameTable img="/prisonner-common-ori.png" />
      <GameTable img="/prisonner-ethic-ori.png" />
    </div>
    <div className="col-10 col-md-5">
      <div className="height-wrapper1">
      ...
      <GameTable img="/volunteer-common-ori.png" />
      <GameTable img="/volunteer-ethic-ori.png" />
    </div>

    <div className="col-10 col-md-5">
      <div className="height-wrapper2">
      ...
      <GameTable img="/buck-common-ori.png" />
      <GameTable img="/buck-ethic-ori.png" />
    </div>
    <div className="col-10 col-md-5">
      <div className="height-wrapper2">
        ...
        <Passage>此賽局和前三個賽局有本質上的差異。在前三個賽局中，受試者必須在合作與背叛兩個策略中做出選擇；但此賽局是金額的分配與接受，和合作背叛沒有直接的關聯。若以「理性」的模型分析此賽局，合理的解將是提議者提出給予反應者1元（最小單位的報酬），而反應者也應當接受此方案。</Passage>
      ...
      <GameTable img="/last-common-ori.png" />
      <GameTable img="/last-ethic-ori.png" />
    </div>
  </div>
);
