...
const MethodPage = () => (
  <div className="methodpage row">
    ...
    <div className="col-10 col-lg-6">
      ...
      <div className="page__passage">賽局理論（Game Theory）希望能瞭解並預測參與者的行為模式，分析他們做決定的情形。應用層面相當廣泛，與許多學科和領域都可以做結合。</div>
      <div className="page__passage">其基本前提假設，是預設所有人都有經濟學上的理性，指的是完全的自利(self-interest)，追求自身利益的極大化。雖可簡化模型的複雜程度，但也因此必須進行更深入且細膩的分析。</div>
      <div className="page__passage">在實驗中，我們使用囚犯兩難、志願者兩難、圍捕公鹿、最後通牒這4種不同的賽局模型，以觀察學生的選擇傾向。</div>
